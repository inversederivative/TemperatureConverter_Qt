...
Item {
    ...
    Button {
        ...
        onClicked: {
            ...
            temperatureConverter.convertTemperatureFromKelvinToFahrenheit(inputField.text)
        }
    }
    ...
    Connections {
        ...
        function onTemperatureConvertedFromKelvinToFahrenheit(fahrenheitTemperature) {
